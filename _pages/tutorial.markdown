...
* No account -- it is possible only to browse data, it is not possible to edit term or vocabularies, show documents or other sources. Functionality is very limited. This Regime shall serve to public to view the data.
...
We recommend to install local instance of TermIt (use guide in <a href="/install">tab Install</a>).
...
In this task we will create new vocabulary, assign a document to it and create few terms. Make sure you have at leas 'Editor' account.
...
In the upper right corner of the page appear several green popups confirming the successful creation of the new vocabulary. They disappear in a while.
...
Go into the Terms tab in the detail of your vocabulary (it shall be open as you open the vocabulary detail). Click a button '+ New term'.
...
In the similar way create terms 'Climate system', 'Emmissions' and 'Greenhouse gases'. They are defined in the UNFCCC document, too.
...
{% include figure image_path="/assets/images/tutorial/validation.png" alt="List of new terms" caption="List of new terms." %}

[comment]: <> přepracuj zbytek sekce (hlavně obrázky), až nebude live demo považovat za chybu chybějící definici v češtině v anglickém slovníku.
...
The picture above shows some of the validation results . No results mean complete term. We will fix the term by the term editing. Click 'Edit' in the upper right corner of the term detail. Shown dialogue is same as for the term creation, but attribute values are already filled.
...
Value of the attribute 'Type' of term 'Emmissions' set to 'Object type'.
...
Check the validation tab again. Some of the results shall disappear. The corrected terms have now green dot next to it.
...
{% include figure image_path="/assets/images/tutorial/confim-occurrence.png" alt="Confirmation of suggested occurrence of an existing term" caption="Confirmation of suggested occurrence of an existing term." %}
...
New pop-up appears. Dialogue is very similar to the creation of a new term directly from vocabulary with one exception. Definition of a term may be selected directly from the text of a document. Click 'Select definition', than mark a definition text from the file. It appears in the form. You may edit it.
...
{% include figure image_path="/assets/images/tutorial-cs/select-text.png" alt="Selection of a text for creation of a an occurrence or definition" caption="Selection of a text for creation of a an occurrence or definition." %}
...
{% include figure image_path="/assets/images/tutorial-cs/defintion.png" alt="Edit definition text and source" caption="Edit definition text and source." %}
